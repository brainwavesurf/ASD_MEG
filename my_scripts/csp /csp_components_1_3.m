...
%     xlabel('#eigenvalue')
%     ylabel('eigenvalue')
%     saveas(figure(1), [savepath, '1_results/CSP_matlab_plots/', subj, '_eigenvalue_new.jpeg']); 
    ...
    slow = cell(1,3);
    epochs_fast = cell(1,3);
    epochs_slow = cell(1,3);
    for n = 1:3
        A_mat = A1;
        for i = 1:3
            if i~=n
    ...
    filename = strcat(savepath, subj, '/', subj, '_fieldtrip_csp_1_3_to_mne.mat');
