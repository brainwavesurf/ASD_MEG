...
%     saveas(figure(1), [savepath, '1_results/CSP_matlab_plots/', subj, 'comparison_eigenvalues_old_and_new.jpeg']); 
    ...
    filename = strcat(savepath, subj, '/', subj, '_csp_analysis_1_6_and_97_102_old.mat');
    ...
    filename = strcat(savepath, subj, '/', subj, '_fieldtrip_csp_1_6_and_97_102_old.mat');  
    ...
    filename = strcat(savepath, subj, '/', subj, '_fieldtrip_csp_1_6_and_97_102_old_to_mne.mat');
...
saveas(figure(1), [savepath, '1_results/CSP_matlab_plots/', subj, '_csp_1_6_timeseries_old.jpeg']);  
...
saveas(figure(1), [savepath, '1_results/CSP_matlab_plots/', subj, '_spectral_power_csp_1_6_timeseries_old.jpeg']);